  ...
  return (
    <div className=" bg-amber-100 min-h-screen">
      <section className="bg-amber-200 mx-28 min-h-screen p-12">
        <h1 className="fond-extradold text-5xl">FAQ</h1>
        <nav className="flex flex-col gap-4 mt-8">
          ...
          <Link 
            href={
              "https://help.tabletopia.com/knowledge-base/fag/mobile-app-help/"
            }
            className="hover:text-red-400 p-3"
          >
            Mobile App Help
          ...
          <section className="bg-slate-300 mx-28 min-h-screen p-12">
            <div className=" p-8 w-[200px] sm:w-[340px] md:w[450px]lg:w-[650px] xl:w-[800px] bg-cyan-600  ">
